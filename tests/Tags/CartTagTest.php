...
class CartTagTest extends TestCase
{
    ...
    public function it_outputs_update_line_item_form()
    {
        ...
        $this->assertStringContainsString('<form method="POST" action="http://localhost/!/cargo/cart/line-items/line-item-1">', $output);
    ...
    public function it_outputs_update_form()
    {
        ...
        $this->assertStringContainsString('<form method="POST" action="http://localhost/!/cargo/cart" class="cart-form">', $output);
        $this->assertStringContainsString('<button>Update</button>', $output);
    }
