...
class StripeTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        config()->set('statamic.cargo.payments.gateways', ['stripe' => [
            'key' => env('STRIPE_KEY'),
            'secret' => env('STRIPE_SECRET'),
            'webhook_secret' => env('STRIPE_WEBHOOK_SECRET'),
        ]]);

        \Stripe\Stripe::setApiKey(config('statamic.cargo.payments.gateways.stripe.secret'));
    }
    ...
    {
        Config::set('statamic.cargo.payments.gateways.stripe.webhook_secret', 'whsec_test_secret');

        $this
            ->post(uri: '/!/cargo/payments/stripe/webhook', headers: [
